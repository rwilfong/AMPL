...
def apply_sampling_method(train, params, random_state=None, seed=None):
    ...
    if params.sampling_method=='SMOTE':
        ...
        print("number of synthetic weights are:", num_synthetic)
        ...
        print("lenght of resampled weights are:", len(resampled_weights))
        ...
        print("Original IDs length:", len(train.ids))
        print("Synthetic IDs length:", len(synthetic_ids))
        #print("the synthetic ids are:", synthetic_ids)
        print("New IDs length:", len(new_ids))
    ...
    print("Resampled X shape:", train_resampled.X.shape)
    print("Resampled y shape:", train_resampled.y.shape)
    print("Resampled weights shape:", train_resampled.w.shape)
    print("Resampled IDs shape:", train_resampled.ids.shape)
    #print("Resampled IDs:", train_resampled.ids)
    return train_resampled

# =====================================================================================================
def apply_kfold_sampling_method(train, params, random_state=None, seed=None):
    """
    Apply a sampling method to a classification dataset when split_strategy=='train_valid_test'

...
def saved_model_identity(pparams):
    ...
    #print('the original model_uuid is:', pparams.output_dir)
    try:
    ...
    #print("the retrained_model output dir is:", retrain_pparams.output_dir)
    with open(os.path.join(pparams.output_dir, 'model_metrics.json'), 'r') as f:
...
if __name__ == "__main__":
    ...
    #print("test_hybrid_regression_train_valid_test_reproducibility")
    #test_hybrid_regression_reproducibility()

    #print("test_multitask_regression_train_valid_test_reproducibility")
    #test_multitask_regression_reproducibility()

...
def test_multitaskscaffold_split_reproducibility():
    script_path = os.path.dirname(os.path.realpath(__file__))
    json_file =  os.path.join(script_path, 'split_json/test_multitaskscaffold_split.json')

    pparams = parse.wrapper(['--config_file', json_file])
    pparams.dataset_key = os.path.join(script_path, 'KCNA5_KCNH2_SCN5A_data.csv')
    pparams.result_dir=script_path
...
if __name__ == "__main__":
    ...
    test_multitaskscaffold_split_reproducibility()